...
import worldClassImg from '@assets/about/image-world-class-talent.jpg';
import worldClassMobileImg from '@assets/about/image-world-class-talent-mobile.jpg';

import realDealImg from '@assets/about/image-real-deal.jpg';
import realDealMobileImg from '@assets/about/image-real-deal-mobile.jpg';
  ...
  return (
    <section className="classicalPage ">
      ...
      <AboutCard
        ...
        imageDesktop={worldClassImg}
        imageMobile={worldClassMobileImg}
      ...
      <AboutCard
        ...
        imageDesktop={realDealImg}
        imageMobile={realDealMobileImg}
        className="flex-row"
      />
    </section>
  );
