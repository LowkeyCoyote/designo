...
const LocationContainer = ({
  ...
  return (
    <div className="mb-8 grid grid-cols-3 grid-rows-1 gap-8 md:mb-0 md:grid-cols-1 md:grid-rows-2 md:gap-0 ">
      <div
        className={`col-span-2 rounded-lg bg-[#FDF3F0] bg-pattern-two-circle bg-left-bottom bg-no-repeat px-24 py-20 text-start ${reverse ? `order-last` : ``} 
        md:order-last md:mb-8 md:px-20 sm:bg-pattern-three-circle sm:bg-left-top sm:text-center`}
      >
