...
const CardProduct = ({ title, subtitle, image, altText }: CardProductProps) => {
  return (
    <div className="flex flex-col overflow-hidden rounded-lg md:flex-row sm:flex-col">
      <div className="md:max-w-[50%] sm:max-w-full">
        <img className="h-max w-max object-fill" src={image} alt={altText} />
      </div>
      <div className="group flex flex-col justify-center bg-[#FDF3F0] p-8 text-center duration-100 hover:bg-peach">
