  ...
  return (
    <div className="relative flex overflow-hidden rounded-2xl bg-peach md:min-w-full sm:rounded-none">
      <div className="fadeInLeft flex w-[60%] flex-col px-24 py-32 md:w-full md:px-20 md:pb-[470px] md:pt-12 md:text-center  sm:px-6  ">
        <h1 className="z-10 mb-9 text-white sm:mb-4">Award-winning custom designs and digital branding solutions</h1>
        <p className="z-10 mb-9 text-white sm:mb-4">
        ...
        <Button link="./about" className="z-10 tracking-wide md:mx-auto">
          Learn More
        </Button>
      </div>
      <div>
      ...
      <img src={BgPatternHeroHome} className="absolute right-0 md:invisible md:top-24 sm:visible" alt="" />
    </div>
  );
};
